...
namespace Absx2.MyPC
{
    ...
    class MyPC
    {
        public static List<string> InfoRAM()
        {
            ...
            foreach (ManagementObject data in Searcher.Get())
            {
                try
                {
                    ...
                    Item.Add(data.GetPropertyValue("Capacity") != null ? data.GetPropertyValue("Capacity").ToString() : "Unavailable");
                }
        ...
        public static List<string> InfoCPU()
        {
            List<string> Item = new List<string>();
            ...
            foreach (ManagementObject data in Searcher.Get())
            {
                try
                {
                    Item.Add(data.GetPropertyValue("CurrentClockSpeed") != null ? data.GetPropertyValue("CurrentClockSpeed").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("CurrentVoltage") != null ? data.GetPropertyValue("CurrentVoltage").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("Manufacturer") != null ? data.GetPropertyValue("Manufacturer").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("MaxClockSpeed") != null ? data.GetPropertyValue("MaxClockSpeed").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("Name") != null ? data.GetPropertyValue("Name").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("NumberOfCores") != null ? data.GetPropertyValue("NumberOfCores").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("NumberOfLogicalProcessors") != null ? data.GetPropertyValue("NumberOfLogicalProcessors").ToString() : "Unavailable");
                    Item.Add(data.GetPropertyValue("SystemName") != null ? data.GetPropertyValue("SystemName").ToString() : "Unavailable");
                }
                catch (ManagementException e)
                {
                    Console.WriteLine(e.ToString());
